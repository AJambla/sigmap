...
description: Latest saved task benchmark for SigMap v8.44.0. 61.0% correct, 43.4% fewer prompts, 78.6% hit@5 across 105 tasks, with R language support.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-09-14 (v8.44.0)** — includes R language support (ggplot2, dplyr, shiny)
