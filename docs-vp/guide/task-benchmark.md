...
description: Latest saved task benchmark for SigMap v8.48.0. 61.9% correct, 43.7% fewer prompts, 78.6% hit@5 across 105 tasks, with R language support.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-09-15 (v8.48.0)** — includes R language support (ggplot2, dplyr, shiny)
