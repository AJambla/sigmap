...
description: SigMap generalizes across 21 repos, 35 languages, and multiple domains with 78.6% hit@5 in the latest saved v8.46.0 retrieval run.
head:
  - - meta
    - property: og:title
      content: "SigMap Generalization — 78.6% hit@5 across 35 languages with R support"
  - - meta
...
::: info Official v8.46.0 benchmark snapshot
**Benchmark ID:** sigmap-v8.46-main &nbsp;·&nbsp; **Date:** 2026-09-14 (with R language)
...
these 105 tasks is yes — 78.6% hit@5 with no per-repo tuning in the latest saved v8.46.0 run.
:::

- **21 repos** (including 3 R language repos)
- **35 languages** (added R and GDScript)
- **multiple domains**
- **78.6%** overall hit@5
- **no per-repo tuning**
...
If you want one number to carry into launch messaging, use the shared `v8.46.0` snapshot rather than an older per-page variant:
