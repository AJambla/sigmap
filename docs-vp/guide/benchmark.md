...
description: Official v8.40.0 benchmark snapshot. 96.6% average token reduction across 21 repos, 78.6% retrieval hit@5, 43.4% fewer prompts, and R language support verified.
head:
  - - meta
    - property: og:title
      content: "SigMap benchmark overview — v8.40.0 snapshot with R language"
  - - meta
    - property: og:description
      content: "Token, retrieval, quality, and task metrics from latest v8.40.0 benchmark run (2026-09-13) with 21 repositories including R language support."
  - - meta
    - property: og:url
...
::: info Official v8.40.0 benchmark snapshot (21 repos, including R language)
**Benchmark ID:** sigmap-v8.40-main &nbsp;·&nbsp; **Date:** 2026-09-13
...
## Official v8.40.0 snapshot (with R language support)

Latest saved benchmark run: **2026-09-13 (v8.40.0)**
