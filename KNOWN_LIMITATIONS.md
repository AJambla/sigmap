...
Currently: **48 extractor modules covering 34 languages**. Counts are guarded against drift by `test/integration/known-limitations.test.js` (they must match `version.json`).
